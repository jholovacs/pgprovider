CREATE OR REPLACE FUNCTION remove_users_from_roles(_users character varying[], _roles character varying[], _application_name character varying) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
	begin
