	...
	public class pgMembershipProvider : MembershipProvider
	{
		...
		public override void Initialize(string name, NameValueCollection config)
		{
			...
			try
			{
				...
				{
					Log.Debug("Password Retrieval is enabled, checking for a valid encryption key...");
			...
			string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status)
		{
			...
			{
				Log.Debug("Password questions are used; updating the question and answer for the user...");
				try
				{
		...
		protected void UpdateQAndA(string username, string question, string answer)
		{
			...
			Log.Debug("Successfully updated the database with question and answer info.");
		}
